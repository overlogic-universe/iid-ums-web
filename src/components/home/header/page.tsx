...
const HeaderSection: NextPage<Props> = ({}) => {
  return (
    <div id="home" className="flex-col min-w-full items-center justify-center">
      <Image className="w-full md:hidden block" src={SvgConstants.headerImageMobile} alt={`${TextConstants.en.header}-mobile`} />
      <Image className="w-full md:block hidden" src={SvgConstants.headerImage} alt={TextConstants.en.header} />
